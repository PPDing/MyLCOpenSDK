...
namespace LCOpenApi{
	...
	typedef SetDeviceAlarmSensitivityRequest::SetDeviceAlarmSensitivityRequestData SetDeviceAlarmSensitivityRequestData;
	...
	typedef SetDeviceAlarmSensitivityResponse::SetDeviceAlarmSensitivityResponseData SetDeviceAlarmSensitivityResponseData;
