...
namespace LCOpenApi{
	...
	typedef ModifyCollectionRequest::ModifyCollectionRequestData ModifyCollectionRequestData;
	...
	typedef ModifyCollectionResponse::ModifyCollectionResponseData ModifyCollectionResponseData;
