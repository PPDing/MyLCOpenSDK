...
namespace LCOpenApi{
	...
	typedef VerifyPasswordRequest::VerifyPasswordRequestData VerifyPasswordRequestData;
	...
	typedef VerifyPasswordResponse::VerifyPasswordResponseData VerifyPasswordResponseData;
