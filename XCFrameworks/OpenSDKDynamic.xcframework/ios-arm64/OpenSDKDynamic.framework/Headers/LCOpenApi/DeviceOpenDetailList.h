...
namespace LCOpenApi{
	...
	typedef DeviceOpenDetailListRequest::DeviceOpenDetailListRequestData DeviceOpenDetailListRequestData;
	typedef DeviceOpenDetailListRequest::DeviceOpenDetailListRequestData::DeviceOpenDetailListRequestData_DeviceListElement DeviceOpenDetailListRequestData_DeviceListElement;
	...
	typedef DeviceOpenDetailListResponse::DeviceOpenDetailListResponseData DeviceOpenDetailListResponseData;
	typedef DeviceOpenDetailListResponse::DeviceOpenDetailListResponseData::DeviceOpenDetailListResponseData_DeviceListElement DeviceOpenDetailListResponseData_DeviceListElement;
	typedef DeviceOpenDetailListResponse::DeviceOpenDetailListResponseData::DeviceOpenDetailListResponseData_DeviceListElement::DeviceOpenDetailListResponseData_DeviceListElement_ChannelsElement DeviceOpenDetailListResponseData_DeviceListElement_ChannelsElement;
	typedef DeviceOpenDetailListResponse::DeviceOpenDetailListResponseData::DeviceOpenDetailListResponseData_DeviceListElement::DeviceOpenDetailListResponseData_DeviceListElement_AplistElement DeviceOpenDetailListResponseData_DeviceListElement_AplistElement;
