...
namespace LCOpenApi{
	...
	typedef QueryLocalRecordBitmapRequest::QueryLocalRecordBitmapRequestData QueryLocalRecordBitmapRequestData;
	...
	typedef QueryLocalRecordBitmapResponse::QueryLocalRecordBitmapResponseData QueryLocalRecordBitmapResponseData;
