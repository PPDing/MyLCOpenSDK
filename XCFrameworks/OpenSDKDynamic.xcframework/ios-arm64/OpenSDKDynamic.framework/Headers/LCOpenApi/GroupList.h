...
namespace LCOpenApi{
	...
	typedef GroupListRequest::GroupListRequestData GroupListRequestData;
	...
	typedef GroupListResponse::GroupListResponseData GroupListResponseData;
	typedef GroupListResponse::GroupListResponseData::GroupListResponseData_GroupsElement GroupListResponseData_GroupsElement;
