...
namespace LCOpenApi{
	...
	typedef QueryLocalRecordsRequest::QueryLocalRecordsRequestData QueryLocalRecordsRequestData;
	...
	typedef QueryLocalRecordsResponse::QueryLocalRecordsResponseData QueryLocalRecordsResponseData;
	typedef QueryLocalRecordsResponse::QueryLocalRecordsResponseData::QueryLocalRecordsResponseData_RecordsElement QueryLocalRecordsResponseData_RecordsElement;
