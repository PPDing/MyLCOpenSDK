...
namespace LCOpenApi{
	...
	typedef LightWorkModeListRequest::LightWorkModeListRequestData LightWorkModeListRequestData;
	...
	typedef LightWorkModeListResponse::LightWorkModeListResponseData LightWorkModeListResponseData;
	typedef LightWorkModeListResponse::LightWorkModeListResponseData::LightWorkModeListResponseData_ValuesElement LightWorkModeListResponseData_ValuesElement;
