...
namespace LCOpenApi{
	...
	typedef LightTimeGetRequest::LightTimeGetRequestData LightTimeGetRequestData;
	...
	typedef LightTimeGetResponse::LightTimeGetResponseData LightTimeGetResponseData;
	typedef LightTimeGetResponse::LightTimeGetResponseData::LightTimeGetResponseData_ValuesElement LightTimeGetResponseData_ValuesElement;
