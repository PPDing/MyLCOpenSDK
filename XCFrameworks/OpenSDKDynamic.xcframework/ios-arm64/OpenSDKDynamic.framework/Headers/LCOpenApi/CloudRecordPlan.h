...
namespace LCOpenApi{
	...
	typedef CloudRecordPlanRequest::CloudRecordPlanRequestData CloudRecordPlanRequestData;
	...
	typedef CloudRecordPlanResponse::CloudRecordPlanResponseData CloudRecordPlanResponseData;
	typedef CloudRecordPlanResponse::CloudRecordPlanResponseData::CloudRecordPlanResponseData_RulesElement CloudRecordPlanResponseData_RulesElement;
