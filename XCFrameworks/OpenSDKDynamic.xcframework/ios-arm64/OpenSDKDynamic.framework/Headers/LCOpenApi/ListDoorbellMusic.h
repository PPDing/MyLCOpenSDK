...
namespace LCOpenApi{
	...
	typedef ListDoorbellMusicRequest::ListDoorbellMusicRequestData ListDoorbellMusicRequestData;
	...
	typedef ListDoorbellMusicResponse::ListDoorbellMusicResponseData ListDoorbellMusicResponseData;
	typedef ListDoorbellMusicResponse::ListDoorbellMusicResponseData::ListDoorbellMusicResponseData_ListElement ListDoorbellMusicResponseData_ListElement;
