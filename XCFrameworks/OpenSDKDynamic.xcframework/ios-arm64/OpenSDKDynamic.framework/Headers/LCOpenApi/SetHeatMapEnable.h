...
namespace LCOpenApi{
	...
	typedef SetHeatMapEnableRequest::SetHeatMapEnableRequestData SetHeatMapEnableRequestData;
	...
	typedef SetHeatMapEnableResponse::SetHeatMapEnableResponseData SetHeatMapEnableResponseData;
