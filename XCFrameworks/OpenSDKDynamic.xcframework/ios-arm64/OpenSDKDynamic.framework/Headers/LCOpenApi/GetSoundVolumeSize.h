...
namespace LCOpenApi{
	...
	typedef GetSoundVolumeSizeRequest::GetSoundVolumeSizeRequestData GetSoundVolumeSizeRequestData;
	...
	typedef GetSoundVolumeSizeResponse::GetSoundVolumeSizeResponseData GetSoundVolumeSizeResponseData;
