...
namespace LCOpenApi{
	...
	typedef UserAuthListRequest::UserAuthListRequestData UserAuthListRequestData;
	...
	typedef UserAuthListResponse::UserAuthListResponseData UserAuthListResponseData;
	typedef UserAuthListResponse::UserAuthListResponseData::UserAuthListResponseData_AuthorizationsElement UserAuthListResponseData_AuthorizationsElement;
	typedef UserAuthListResponse::UserAuthListResponseData::UserAuthListResponseData_AuthorizationsElement::UserAuthListResponseData_AuthorizationsElement_Role UserAuthListResponseData_AuthorizationsElement_Role;
	typedef UserAuthListResponse::UserAuthListResponseData::UserAuthListResponseData_AuthorizationsElement::UserAuthListResponseData_AuthorizationsElement_AuthDevicesElement UserAuthListResponseData_AuthorizationsElement_AuthDevicesElement;
