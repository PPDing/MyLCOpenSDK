...
namespace LCOpenApi{
	...
	typedef DeleteCloudPlanRecordsRequest::DeleteCloudPlanRecordsRequestData DeleteCloudPlanRecordsRequestData;
	...
	typedef DeleteCloudPlanRecordsResponse::DeleteCloudPlanRecordsResponseData DeleteCloudPlanRecordsResponseData;
