...
namespace LCOpenApi{
	...
	typedef ModifyLivePlanStatusRequest::ModifyLivePlanStatusRequestData ModifyLivePlanStatusRequestData;
	...
	typedef ModifyLivePlanStatusResponse::ModifyLivePlanStatusResponseData ModifyLivePlanStatusResponseData;
