...
namespace LCOpenApi{
	...
	typedef GetCollectionRequest::GetCollectionRequestData GetCollectionRequestData;
	...
	typedef GetCollectionResponse::GetCollectionResponseData GetCollectionResponseData;
	typedef GetCollectionResponse::GetCollectionResponseData::GetCollectionResponseData_CollectionsElement GetCollectionResponseData_CollectionsElement;
