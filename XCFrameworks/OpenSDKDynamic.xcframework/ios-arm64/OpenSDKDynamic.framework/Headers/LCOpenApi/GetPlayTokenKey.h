...
namespace LCOpenApi{
	...
	typedef GetPlayTokenKeyRequest::GetPlayTokenKeyRequestData GetPlayTokenKeyRequestData;
	...
	typedef GetPlayTokenKeyResponse::GetPlayTokenKeyResponseData GetPlayTokenKeyResponseData;
