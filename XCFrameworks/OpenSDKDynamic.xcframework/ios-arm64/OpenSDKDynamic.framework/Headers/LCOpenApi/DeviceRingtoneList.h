...
namespace LCOpenApi{
	...
	typedef DeviceRingtoneListRequest::DeviceRingtoneListRequestData DeviceRingtoneListRequestData;
	...
	typedef DeviceRingtoneListResponse::DeviceRingtoneListResponseData DeviceRingtoneListResponseData;
	typedef DeviceRingtoneListResponse::DeviceRingtoneListResponseData::DeviceRingtoneListResponseData_ListElement DeviceRingtoneListResponseData_ListElement;
