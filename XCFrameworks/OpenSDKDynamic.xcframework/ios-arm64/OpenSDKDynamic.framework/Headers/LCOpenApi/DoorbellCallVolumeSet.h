...
namespace LCOpenApi{
	...
	typedef DoorbellCallVolumeSetRequest::DoorbellCallVolumeSetRequestData DoorbellCallVolumeSetRequestData;
	...
	typedef DoorbellCallVolumeSetResponse::DoorbellCallVolumeSetResponseData DoorbellCallVolumeSetResponseData;
