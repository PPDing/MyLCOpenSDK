...
namespace LCOpenApi{
	...
	typedef UserTokenByAccountRequest::UserTokenByAccountRequestData UserTokenByAccountRequestData;
	...
	typedef UserTokenByAccountResponse::UserTokenByAccountResponseData UserTokenByAccountResponseData;
