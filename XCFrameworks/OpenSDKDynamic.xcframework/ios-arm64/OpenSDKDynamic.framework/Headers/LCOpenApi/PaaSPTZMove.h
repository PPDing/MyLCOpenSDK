...
namespace LCOpenApi{
	class MetaInfo;
	using namespace std;
	class PaaSPTZMoveRequest : public LCOpenApiRequest
	{
	public:
		class PaaSPTZMoveRequestData
		{
		public:
			PaaSPTZMoveRequestData();
			~PaaSPTZMoveRequestData();
	...
	public:
		PaaSPTZMoveRequestData data;
		MetaInfo* _metainfo_PaaSPTZMoveRequestData;
	};

	
	typedef PaaSPTZMoveRequest::PaaSPTZMoveRequestData PaaSPTZMoveRequestData;


	class PaaSPTZMoveResponse : public LCOpenApiResponse
	{
	public:
		class PaaSPTZMoveResponseData
		{
		public:
			PaaSPTZMoveResponseData();
			~PaaSPTZMoveResponseData();
	...
	public:
		...
		virtual int parse();
	public:
		PaaSPTZMoveResponseData data;
		MetaInfo* _metainfo_PaaSPTZMoveResponseData;
	};

	
	typedef PaaSPTZMoveResponse::PaaSPTZMoveResponseData PaaSPTZMoveResponseData;
