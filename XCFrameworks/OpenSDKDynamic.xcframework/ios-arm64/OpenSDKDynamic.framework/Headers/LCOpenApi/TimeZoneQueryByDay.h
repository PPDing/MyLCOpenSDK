...
namespace LCOpenApi{
	...
	typedef TimeZoneQueryByDayRequest::TimeZoneQueryByDayRequestData TimeZoneQueryByDayRequestData;
	...
	typedef TimeZoneQueryByDayResponse::TimeZoneQueryByDayResponseData TimeZoneQueryByDayResponseData;
