...
namespace LCOpenApi{
	...
	typedef DeleteAlarmMessageRequest::DeleteAlarmMessageRequestData DeleteAlarmMessageRequestData;
	...
	typedef DeleteAlarmMessageResponse::DeleteAlarmMessageResponseData DeleteAlarmMessageResponseData;
