...
namespace LCOpenApi{
	...
	typedef QueryCloudPlanRecordBitmapRequest::QueryCloudPlanRecordBitmapRequestData QueryCloudPlanRecordBitmapRequestData;
	...
	typedef QueryCloudPlanRecordBitmapResponse::QueryCloudPlanRecordBitmapResponseData QueryCloudPlanRecordBitmapResponseData;
