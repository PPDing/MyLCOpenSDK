...
namespace LCOpenApi{
	...
	typedef LightTimeSetRequest::LightTimeSetRequestData LightTimeSetRequestData;
	...
	typedef LightTimeSetResponse::LightTimeSetResponseData LightTimeSetResponseData;
