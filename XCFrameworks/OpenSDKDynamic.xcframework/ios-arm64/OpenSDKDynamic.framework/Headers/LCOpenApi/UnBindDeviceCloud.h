...
namespace LCOpenApi{
	...
	typedef UnBindDeviceCloudRequest::UnBindDeviceCloudRequestData UnBindDeviceCloudRequestData;
	...
	typedef UnBindDeviceCloudResponse::UnBindDeviceCloudResponseData UnBindDeviceCloudResponseData;
