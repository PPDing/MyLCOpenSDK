...
namespace LCOpenApi{
	...
	typedef WifiAroundRequest::WifiAroundRequestData WifiAroundRequestData;
	...
	typedef WifiAroundResponse::WifiAroundResponseData WifiAroundResponseData;
	typedef WifiAroundResponse::WifiAroundResponseData::WifiAroundResponseData_WLanElement WifiAroundResponseData_WLanElement;
