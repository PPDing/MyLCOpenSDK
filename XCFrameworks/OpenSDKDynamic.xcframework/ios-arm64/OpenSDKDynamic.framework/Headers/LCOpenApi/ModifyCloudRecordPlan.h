...
namespace LCOpenApi{
	...
	typedef ModifyCloudRecordPlanRequest::ModifyCloudRecordPlanRequestData ModifyCloudRecordPlanRequestData;
	...
	typedef ModifyCloudRecordPlanResponse::ModifyCloudRecordPlanResponseData ModifyCloudRecordPlanResponseData;
