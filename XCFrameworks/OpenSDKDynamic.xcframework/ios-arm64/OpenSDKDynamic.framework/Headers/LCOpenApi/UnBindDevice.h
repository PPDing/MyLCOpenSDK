...
namespace LCOpenApi{
	...
	typedef UnBindDeviceRequest::UnBindDeviceRequestData UnBindDeviceRequestData;
	...
	typedef UnBindDeviceResponse::UnBindDeviceResponseData UnBindDeviceResponseData;
