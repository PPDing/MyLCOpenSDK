...
namespace LCOpenApi{
	...
	typedef AddGroupDeviceRequest::AddGroupDeviceRequestData AddGroupDeviceRequestData;
	...
	typedef AddGroupDeviceResponse::AddGroupDeviceResponseData AddGroupDeviceResponseData;
