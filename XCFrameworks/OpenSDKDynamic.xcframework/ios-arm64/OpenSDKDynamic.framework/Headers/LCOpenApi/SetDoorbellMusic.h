...
namespace LCOpenApi{
	...
	typedef SetDoorbellMusicRequest::SetDoorbellMusicRequestData SetDoorbellMusicRequestData;
	...
	typedef SetDoorbellMusicResponse::SetDoorbellMusicResponseData SetDoorbellMusicResponseData;
