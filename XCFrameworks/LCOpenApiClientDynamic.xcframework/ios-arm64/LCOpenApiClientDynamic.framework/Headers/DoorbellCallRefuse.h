...
namespace LCOpenApi{
	...
	typedef DoorbellCallRefuseRequest::DoorbellCallRefuseRequestData DoorbellCallRefuseRequestData;
	...
	typedef DoorbellCallRefuseResponse::DoorbellCallRefuseResponseData DoorbellCallRefuseResponseData;
