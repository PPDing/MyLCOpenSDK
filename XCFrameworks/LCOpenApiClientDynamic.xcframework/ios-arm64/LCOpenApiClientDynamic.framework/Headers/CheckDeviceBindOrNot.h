...
namespace LCOpenApi{
	...
	typedef CheckDeviceBindOrNotRequest::CheckDeviceBindOrNotRequestData CheckDeviceBindOrNotRequestData;
	...
	typedef CheckDeviceBindOrNotResponse::CheckDeviceBindOrNotResponseData CheckDeviceBindOrNotResponseData;
