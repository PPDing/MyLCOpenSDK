...
namespace LCOpenApi{
	...
	typedef OtherRingTypeListRequest::OtherRingTypeListRequestData OtherRingTypeListRequestData;
	...
	typedef OtherRingTypeListResponse::OtherRingTypeListResponseData OtherRingTypeListResponseData;
