...
namespace LCOpenApi{
	...
	typedef DeviceNumberStatReportRequest::DeviceNumberStatReportRequestData DeviceNumberStatReportRequestData;
	...
	typedef DeviceNumberStatReportResponse::DeviceNumberStatReportResponseData DeviceNumberStatReportResponseData;
