...
namespace LCOpenApi{
	...
	typedef GetDeviceCloudRequest::GetDeviceCloudRequestData GetDeviceCloudRequestData;
	...
	typedef GetDeviceCloudResponse::GetDeviceCloudResponseData GetDeviceCloudResponseData;
