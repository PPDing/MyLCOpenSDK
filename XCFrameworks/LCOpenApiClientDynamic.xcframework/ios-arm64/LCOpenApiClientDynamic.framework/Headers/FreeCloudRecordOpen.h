...
namespace LCOpenApi{
	...
	typedef FreeCloudRecordOpenRequest::FreeCloudRecordOpenRequestData FreeCloudRecordOpenRequestData;
	...
	typedef FreeCloudRecordOpenResponse::FreeCloudRecordOpenResponseData FreeCloudRecordOpenResponseData;
