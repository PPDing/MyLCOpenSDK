...
namespace LCOpenApi{
	...
	typedef GetRecordByLinkageIdRequest::GetRecordByLinkageIdRequestData GetRecordByLinkageIdRequestData;
	...
	typedef GetRecordByLinkageIdResponse::GetRecordByLinkageIdResponseData GetRecordByLinkageIdResponseData;
