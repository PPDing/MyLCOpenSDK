...
namespace LCOpenApi{
	...
	typedef ModifyFrameReverseStatusRequest::ModifyFrameReverseStatusRequestData ModifyFrameReverseStatusRequestData;
	...
	typedef ModifyFrameReverseStatusResponse::ModifyFrameReverseStatusResponseData ModifyFrameReverseStatusResponseData;
