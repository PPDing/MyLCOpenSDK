...
namespace LCOpenApi{
	...
	typedef GetHeatMapDataRequest::GetHeatMapDataRequestData GetHeatMapDataRequestData;
	...
	typedef GetHeatMapDataResponse::GetHeatMapDataResponseData GetHeatMapDataResponseData;
	typedef GetHeatMapDataResponse::GetHeatMapDataResponseData::GetHeatMapDataResponseData_Details GetHeatMapDataResponseData_Details;
