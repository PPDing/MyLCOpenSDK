...
namespace LCOpenApi{
	...
	typedef DeleteCollectionRequest::DeleteCollectionRequestData DeleteCollectionRequestData;
	...
	typedef DeleteCollectionResponse::DeleteCollectionResponseData DeleteCollectionResponseData;
