...
namespace LCOpenApi{
	...
	typedef BeSharedDeviceDeleteRequest::BeSharedDeviceDeleteRequestData BeSharedDeviceDeleteRequestData;
	...
	typedef BeSharedDeviceDeleteResponse::BeSharedDeviceDeleteResponseData BeSharedDeviceDeleteResponseData;
