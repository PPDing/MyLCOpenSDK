...
namespace LCOpenApi{
	...
	typedef GetStorageStrategyRequest::GetStorageStrategyRequestData GetStorageStrategyRequestData;
	...
	typedef GetStorageStrategyResponse::GetStorageStrategyResponseData GetStorageStrategyResponseData;
