...
namespace LCOpenApi{
	...
	typedef SetAllStorageStrategyRequest::SetAllStorageStrategyRequestData SetAllStorageStrategyRequestData;
	...
	typedef SetAllStorageStrategyResponse::SetAllStorageStrategyResponseData SetAllStorageStrategyResponseData;
