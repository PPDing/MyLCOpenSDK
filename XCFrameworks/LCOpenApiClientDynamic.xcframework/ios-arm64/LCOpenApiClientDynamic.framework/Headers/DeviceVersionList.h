...
namespace LCOpenApi{
	...
	typedef DeviceVersionListRequest::DeviceVersionListRequestData DeviceVersionListRequestData;
	...
	typedef DeviceVersionListResponse::DeviceVersionListResponseData DeviceVersionListResponseData;
	typedef DeviceVersionListResponse::DeviceVersionListResponseData::DeviceVersionListResponseData_DeviceVersionListElement DeviceVersionListResponseData_DeviceVersionListElement;
	typedef DeviceVersionListResponse::DeviceVersionListResponseData::DeviceVersionListResponseData_DeviceVersionListElement::DeviceVersionListResponseData_DeviceVersionListElement_UpgradeInfo DeviceVersionListResponseData_DeviceVersionListElement_UpgradeInfo;
