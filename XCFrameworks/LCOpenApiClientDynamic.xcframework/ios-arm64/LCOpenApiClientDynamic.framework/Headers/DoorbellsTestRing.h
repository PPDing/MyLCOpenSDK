...
namespace LCOpenApi{
	...
	typedef DoorbellsTestRingRequest::DoorbellsTestRingRequestData DoorbellsTestRingRequestData;
	...
	typedef DoorbellsTestRingResponse::DoorbellsTestRingResponseData DoorbellsTestRingResponseData;
