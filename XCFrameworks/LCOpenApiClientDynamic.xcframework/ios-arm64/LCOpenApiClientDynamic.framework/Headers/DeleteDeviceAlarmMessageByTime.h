...
namespace LCOpenApi{
	...
	typedef DeleteDeviceAlarmMessageByTimeRequest::DeleteDeviceAlarmMessageByTimeRequestData DeleteDeviceAlarmMessageByTimeRequestData;
	...
	typedef DeleteDeviceAlarmMessageByTimeResponse::DeleteDeviceAlarmMessageByTimeResponseData DeleteDeviceAlarmMessageByTimeResponseData;
