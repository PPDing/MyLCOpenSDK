...
namespace LCOpenApi{
	...
	typedef PirSensitivityListRequest::PirSensitivityListRequestData PirSensitivityListRequestData;
	...
	typedef PirSensitivityListResponse::PirSensitivityListResponseData PirSensitivityListResponseData;
	typedef PirSensitivityListResponse::PirSensitivityListResponseData::PirSensitivityListResponseData_ShapedEnableElement PirSensitivityListResponseData_ShapedEnableElement;
