...
namespace LCOpenApi{
	...
	typedef AlarmPushSwitchGetRequest::AlarmPushSwitchGetRequestData AlarmPushSwitchGetRequestData;
	...
	typedef AlarmPushSwitchGetResponse::AlarmPushSwitchGetResponseData AlarmPushSwitchGetResponseData;
