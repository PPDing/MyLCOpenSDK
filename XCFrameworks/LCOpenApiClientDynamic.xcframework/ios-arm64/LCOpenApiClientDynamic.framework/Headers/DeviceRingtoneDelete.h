...
namespace LCOpenApi{
	...
	typedef DeviceRingtoneDeleteRequest::DeviceRingtoneDeleteRequestData DeviceRingtoneDeleteRequestData;
	...
	typedef DeviceRingtoneDeleteResponse::DeviceRingtoneDeleteResponseData DeviceRingtoneDeleteResponseData;
