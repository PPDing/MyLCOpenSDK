...
namespace LCOpenApi{
	...
	typedef ModifyLivePlanRequest::ModifyLivePlanRequestData ModifyLivePlanRequestData;
	...
	typedef ModifyLivePlanResponse::ModifyLivePlanResponseData ModifyLivePlanResponseData;
