...
namespace LCOpenApi{
	...
	typedef FrameReverseStatusRequest::FrameReverseStatusRequestData FrameReverseStatusRequestData;
	...
	typedef FrameReverseStatusResponse::FrameReverseStatusResponseData FrameReverseStatusResponseData;
