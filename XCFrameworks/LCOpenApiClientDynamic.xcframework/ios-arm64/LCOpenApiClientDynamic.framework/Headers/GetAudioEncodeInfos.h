...
namespace LCOpenApi{
	...
	typedef GetAudioEncodeInfosRequest::GetAudioEncodeInfosRequestData GetAudioEncodeInfosRequestData;
	...
	typedef GetAudioEncodeInfosResponse::GetAudioEncodeInfosResponseData GetAudioEncodeInfosResponseData;
	typedef GetAudioEncodeInfosResponse::GetAudioEncodeInfosResponseData::GetAudioEncodeInfosResponseData_EncodeInfosElement GetAudioEncodeInfosResponseData_EncodeInfosElement;
