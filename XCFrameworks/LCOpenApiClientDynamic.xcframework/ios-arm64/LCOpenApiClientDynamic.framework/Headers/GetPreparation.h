...
namespace LCOpenApi{
	...
	typedef GetPreparationRequest::GetPreparationRequestData GetPreparationRequestData;
	...
	typedef GetPreparationResponse::GetPreparationResponseData GetPreparationResponseData;
