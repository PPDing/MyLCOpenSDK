...
namespace LCOpenApi{
	...
	typedef DevicePTZInfoRequest::DevicePTZInfoRequestData DevicePTZInfoRequestData;
	...
	typedef DevicePTZInfoResponse::DevicePTZInfoResponseData DevicePTZInfoResponseData;
