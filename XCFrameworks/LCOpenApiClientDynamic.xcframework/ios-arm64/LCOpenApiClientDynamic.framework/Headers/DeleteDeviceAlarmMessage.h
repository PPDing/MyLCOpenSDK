...
namespace LCOpenApi{
	...
	typedef DeleteDeviceAlarmMessageRequest::DeleteDeviceAlarmMessageRequestData DeleteDeviceAlarmMessageRequestData;
	...
	typedef DeleteDeviceAlarmMessageResponse::DeleteDeviceAlarmMessageResponseData DeleteDeviceAlarmMessageResponseData;
