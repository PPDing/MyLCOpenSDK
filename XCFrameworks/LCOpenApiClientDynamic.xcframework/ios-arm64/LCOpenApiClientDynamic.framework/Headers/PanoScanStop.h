...
namespace LCOpenApi{
	...
	typedef PanoScanStopRequest::PanoScanStopRequestData PanoScanStopRequestData;
	...
	typedef PanoScanStopResponse::PanoScanStopResponseData PanoScanStopResponseData;
