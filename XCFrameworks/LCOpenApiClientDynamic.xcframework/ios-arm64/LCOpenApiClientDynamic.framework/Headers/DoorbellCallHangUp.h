...
namespace LCOpenApi{
	...
	typedef DoorbellCallHangUpRequest::DoorbellCallHangUpRequestData DoorbellCallHangUpRequestData;
	...
	typedef DoorbellCallHangUpResponse::DoorbellCallHangUpResponseData DoorbellCallHangUpResponseData;
