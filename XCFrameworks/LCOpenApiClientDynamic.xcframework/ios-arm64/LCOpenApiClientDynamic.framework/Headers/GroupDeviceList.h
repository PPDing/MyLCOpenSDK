...
namespace LCOpenApi{
	...
	typedef GroupDeviceListRequest::GroupDeviceListRequestData GroupDeviceListRequestData;
	...
	typedef GroupDeviceListResponse::GroupDeviceListResponseData GroupDeviceListResponseData;
	typedef GroupDeviceListResponse::GroupDeviceListResponseData::GroupDeviceListResponseData_DevicesElement GroupDeviceListResponseData_DevicesElement;
	typedef GroupDeviceListResponse::GroupDeviceListResponseData::GroupDeviceListResponseData_DevicesElement::GroupDeviceListResponseData_DevicesElement_ChannelsElement GroupDeviceListResponseData_DevicesElement_ChannelsElement;
