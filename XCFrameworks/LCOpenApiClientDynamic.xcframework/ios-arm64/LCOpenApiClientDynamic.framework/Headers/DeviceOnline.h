...
namespace LCOpenApi{
	...
	typedef DeviceOnlineRequest::DeviceOnlineRequestData DeviceOnlineRequestData;
	...
	typedef DeviceOnlineResponse::DeviceOnlineResponseData DeviceOnlineResponseData;
	typedef DeviceOnlineResponse::DeviceOnlineResponseData::DeviceOnlineResponseData_ChannelsElement DeviceOnlineResponseData_ChannelsElement;
