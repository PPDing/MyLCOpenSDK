...
namespace LCOpenApi{
	...
	typedef GetLatestAlarmMessageRequest::GetLatestAlarmMessageRequestData GetLatestAlarmMessageRequestData;
	typedef GetLatestAlarmMessageRequest::GetLatestAlarmMessageRequestData::GetLatestAlarmMessageRequestData_DeviceListElement GetLatestAlarmMessageRequestData_DeviceListElement;
	...
	typedef GetLatestAlarmMessageResponse::GetLatestAlarmMessageResponseData GetLatestAlarmMessageResponseData;
	typedef GetLatestAlarmMessageResponse::GetLatestAlarmMessageResponseData::GetLatestAlarmMessageResponseData_AlarmListElement GetLatestAlarmMessageResponseData_AlarmListElement;
	typedef GetLatestAlarmMessageResponse::GetLatestAlarmMessageResponseData::GetLatestAlarmMessageResponseData_AlarmListElement::GetLatestAlarmMessageResponseData_AlarmListElement_ChannelAlarmsElement GetLatestAlarmMessageResponseData_AlarmListElement_ChannelAlarmsElement;
	typedef GetLatestAlarmMessageResponse::GetLatestAlarmMessageResponseData::GetLatestAlarmMessageResponseData_AlarmListElement::GetLatestAlarmMessageResponseData_AlarmListElement_ApAlarmsElement GetLatestAlarmMessageResponseData_AlarmListElement_ApAlarmsElement;
