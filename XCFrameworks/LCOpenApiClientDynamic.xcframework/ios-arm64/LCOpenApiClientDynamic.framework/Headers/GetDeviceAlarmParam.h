...
namespace LCOpenApi{
	...
	typedef GetDeviceAlarmParamRequest::GetDeviceAlarmParamRequestData GetDeviceAlarmParamRequestData;
	...
	typedef GetDeviceAlarmParamResponse::GetDeviceAlarmParamResponseData GetDeviceAlarmParamResponseData;
