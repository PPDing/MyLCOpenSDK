...
namespace LCOpenApi{
	...
	typedef SetPreparationRequest::SetPreparationRequestData SetPreparationRequestData;
	...
	typedef SetPreparationResponse::SetPreparationResponseData SetPreparationResponseData;
