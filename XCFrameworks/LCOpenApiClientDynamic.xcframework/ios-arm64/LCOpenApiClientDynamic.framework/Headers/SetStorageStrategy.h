...
namespace LCOpenApi{
	...
	typedef SetStorageStrategyRequest::SetStorageStrategyRequestData SetStorageStrategyRequestData;
	...
	typedef SetStorageStrategyResponse::SetStorageStrategyResponseData SetStorageStrategyResponseData;
