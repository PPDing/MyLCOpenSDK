...
namespace LCOpenApi{
	...
	typedef SetDoorbellMusicVolumeRequest::SetDoorbellMusicVolumeRequestData SetDoorbellMusicVolumeRequestData;
	...
	typedef SetDoorbellMusicVolumeResponse::SetDoorbellMusicVolumeResponseData SetDoorbellMusicVolumeResponseData;
