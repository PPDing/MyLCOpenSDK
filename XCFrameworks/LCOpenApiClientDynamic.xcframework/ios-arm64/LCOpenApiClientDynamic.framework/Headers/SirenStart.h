...
namespace LCOpenApi{
	...
	typedef SirenStartRequest::SirenStartRequestData SirenStartRequestData;
	...
	typedef SirenStartResponse::SirenStartResponseData SirenStartResponseData;
	typedef SirenStartResponse::SirenStartResponseData::SirenStartResponseData_ChannelsElement SirenStartResponseData_ChannelsElement;
