...
namespace LCOpenApi{
	...
	typedef RecoverSDCardRequest::RecoverSDCardRequestData RecoverSDCardRequestData;
	...
	typedef RecoverSDCardResponse::RecoverSDCardResponseData RecoverSDCardResponseData;
