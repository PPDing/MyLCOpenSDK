...
namespace LCOpenApi{
	...
	typedef QueryCloudPlanRecordNumRequest::QueryCloudPlanRecordNumRequestData QueryCloudPlanRecordNumRequestData;
	...
	typedef QueryCloudPlanRecordNumResponse::QueryCloudPlanRecordNumResponseData QueryCloudPlanRecordNumResponseData;
