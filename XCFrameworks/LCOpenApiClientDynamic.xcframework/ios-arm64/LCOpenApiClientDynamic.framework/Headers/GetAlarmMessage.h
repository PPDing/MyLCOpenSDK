...
namespace LCOpenApi{
	...
	typedef GetAlarmMessageRequest::GetAlarmMessageRequestData GetAlarmMessageRequestData;
	...
	typedef GetAlarmMessageResponse::GetAlarmMessageResponseData GetAlarmMessageResponseData;
	typedef GetAlarmMessageResponse::GetAlarmMessageResponseData::GetAlarmMessageResponseData_AlarmsElement GetAlarmMessageResponseData_AlarmsElement;
