...
namespace LCOpenApi{
	...
	typedef PanoLocationControlRequest::PanoLocationControlRequestData PanoLocationControlRequestData;
	...
	typedef PanoLocationControlResponse::PanoLocationControlResponseData PanoLocationControlResponseData;
