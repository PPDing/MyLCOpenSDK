...
namespace LCOpenApi{
	...
	typedef ModifyPasswordRequest::ModifyPasswordRequestData ModifyPasswordRequestData;
	...
	typedef ModifyPasswordResponse::ModifyPasswordResponseData ModifyPasswordResponseData;
