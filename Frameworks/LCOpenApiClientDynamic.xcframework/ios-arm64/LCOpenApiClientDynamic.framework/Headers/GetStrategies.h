...
namespace LCOpenApi{
	...
	typedef GetStrategiesRequest::GetStrategiesRequestData GetStrategiesRequestData;
	...
	typedef GetStrategiesResponse::GetStrategiesResponseData GetStrategiesResponseData;
	typedef GetStrategiesResponse::GetStrategiesResponseData::GetStrategiesResponseData_StrategiesElement GetStrategiesResponseData_StrategiesElement;
