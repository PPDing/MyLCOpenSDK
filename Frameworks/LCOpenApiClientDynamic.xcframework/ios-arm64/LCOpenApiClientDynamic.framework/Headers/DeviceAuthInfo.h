...
namespace LCOpenApi{
	...
	typedef DeviceAuthInfoRequest::DeviceAuthInfoRequestData DeviceAuthInfoRequestData;
	...
	typedef DeviceAuthInfoResponse::DeviceAuthInfoResponseData DeviceAuthInfoResponseData;
	typedef DeviceAuthInfoResponse::DeviceAuthInfoResponseData::DeviceAuthInfoResponseData_ShareInfosElement DeviceAuthInfoResponseData_ShareInfosElement;
