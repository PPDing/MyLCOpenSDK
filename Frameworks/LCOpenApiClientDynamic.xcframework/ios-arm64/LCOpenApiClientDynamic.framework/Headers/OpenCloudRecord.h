...
namespace LCOpenApi{
	...
	typedef OpenCloudRecordRequest::OpenCloudRecordRequestData OpenCloudRecordRequestData;
	...
	typedef OpenCloudRecordResponse::OpenCloudRecordResponseData OpenCloudRecordResponseData;
