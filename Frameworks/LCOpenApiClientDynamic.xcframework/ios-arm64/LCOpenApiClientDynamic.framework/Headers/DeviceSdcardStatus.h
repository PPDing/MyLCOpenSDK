...
namespace LCOpenApi{
	...
	typedef DeviceSdcardStatusRequest::DeviceSdcardStatusRequestData DeviceSdcardStatusRequestData;
	...
	typedef DeviceSdcardStatusResponse::DeviceSdcardStatusResponseData DeviceSdcardStatusResponseData;
