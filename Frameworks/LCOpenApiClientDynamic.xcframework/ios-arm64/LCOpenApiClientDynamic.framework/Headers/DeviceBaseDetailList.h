...
namespace LCOpenApi{
	...
	typedef DeviceBaseDetailListRequest::DeviceBaseDetailListRequestData DeviceBaseDetailListRequestData;
	typedef DeviceBaseDetailListRequest::DeviceBaseDetailListRequestData::DeviceBaseDetailListRequestData_DeviceListElement DeviceBaseDetailListRequestData_DeviceListElement;
	...
	typedef DeviceBaseDetailListResponse::DeviceBaseDetailListResponseData DeviceBaseDetailListResponseData;
	typedef DeviceBaseDetailListResponse::DeviceBaseDetailListResponseData::DeviceBaseDetailListResponseData_DeviceListElement DeviceBaseDetailListResponseData_DeviceListElement;
	typedef DeviceBaseDetailListResponse::DeviceBaseDetailListResponseData::DeviceBaseDetailListResponseData_DeviceListElement::DeviceBaseDetailListResponseData_DeviceListElement_ChannelsElement DeviceBaseDetailListResponseData_DeviceListElement_ChannelsElement;
	typedef DeviceBaseDetailListResponse::DeviceBaseDetailListResponseData::DeviceBaseDetailListResponseData_DeviceListElement::DeviceBaseDetailListResponseData_DeviceListElement_AplistElement DeviceBaseDetailListResponseData_DeviceListElement_AplistElement;
