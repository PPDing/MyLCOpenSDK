...
namespace LCOpenApi{
	...
	typedef SetDeviceSnapEnhancedRequest::SetDeviceSnapEnhancedRequestData SetDeviceSnapEnhancedRequestData;
	...
	typedef SetDeviceSnapEnhancedResponse::SetDeviceSnapEnhancedResponseData SetDeviceSnapEnhancedResponseData;
