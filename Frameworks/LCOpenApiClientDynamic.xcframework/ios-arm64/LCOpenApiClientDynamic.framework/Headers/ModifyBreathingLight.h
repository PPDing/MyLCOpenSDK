...
namespace LCOpenApi{
	...
	typedef ModifyBreathingLightRequest::ModifyBreathingLightRequestData ModifyBreathingLightRequestData;
	...
	typedef ModifyBreathingLightResponse::ModifyBreathingLightResponseData ModifyBreathingLightResponseData;
