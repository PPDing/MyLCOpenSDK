...
namespace LCOpenApi{
	...
	typedef ExDeviceSharedInfoRequest::ExDeviceSharedInfoRequestData ExDeviceSharedInfoRequestData;
	...
	typedef ExDeviceSharedInfoResponse::ExDeviceSharedInfoResponseData ExDeviceSharedInfoResponseData;
	typedef ExDeviceSharedInfoResponse::ExDeviceSharedInfoResponseData::ExDeviceSharedInfoResponseData_ShareInfoListElement ExDeviceSharedInfoResponseData_ShareInfoListElement;
