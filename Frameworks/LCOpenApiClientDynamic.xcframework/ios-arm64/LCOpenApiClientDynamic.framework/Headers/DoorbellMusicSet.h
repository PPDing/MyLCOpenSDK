...
namespace LCOpenApi{
	...
	typedef DoorbellMusicSetRequest::DoorbellMusicSetRequestData DoorbellMusicSetRequestData;
	...
	typedef DoorbellMusicSetResponse::DoorbellMusicSetResponseData DoorbellMusicSetResponseData;
