...
namespace LCOpenApi{
	...
	typedef SetCollectionRequest::SetCollectionRequestData SetCollectionRequestData;
	...
	typedef SetCollectionResponse::SetCollectionResponseData SetCollectionResponseData;
