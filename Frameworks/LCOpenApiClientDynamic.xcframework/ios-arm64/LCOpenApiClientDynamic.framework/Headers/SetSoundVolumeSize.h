...
namespace LCOpenApi{
	...
	typedef SetSoundVolumeSizeRequest::SetSoundVolumeSizeRequestData SetSoundVolumeSizeRequestData;
	...
	typedef SetSoundVolumeSizeResponse::SetSoundVolumeSizeResponseData SetSoundVolumeSizeResponseData;
