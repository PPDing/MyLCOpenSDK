...
namespace LCOpenApi{
	...
	typedef DoorbellCallAnswerRequest::DoorbellCallAnswerRequestData DoorbellCallAnswerRequestData;
	...
	typedef DoorbellCallAnswerResponse::DoorbellCallAnswerResponseData DoorbellCallAnswerResponseData;
