...
namespace LCOpenApi{
	...
	typedef QueryCloudRecordByTokenRequest::QueryCloudRecordByTokenRequestData QueryCloudRecordByTokenRequestData;
	...
	typedef QueryCloudRecordByTokenResponse::QueryCloudRecordByTokenResponseData QueryCloudRecordByTokenResponseData;
