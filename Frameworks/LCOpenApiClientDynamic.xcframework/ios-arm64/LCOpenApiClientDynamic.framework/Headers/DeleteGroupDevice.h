...
namespace LCOpenApi{
	...
	typedef DeleteGroupDeviceRequest::DeleteGroupDeviceRequestData DeleteGroupDeviceRequestData;
	...
	typedef DeleteGroupDeviceResponse::DeleteGroupDeviceResponseData DeleteGroupDeviceResponseData;
