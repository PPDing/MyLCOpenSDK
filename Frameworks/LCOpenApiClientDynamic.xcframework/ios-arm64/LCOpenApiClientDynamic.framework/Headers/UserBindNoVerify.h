...
namespace LCOpenApi{
	...
	typedef UserBindNoVerifyRequest::UserBindNoVerifyRequestData UserBindNoVerifyRequestData;
	...
	typedef UserBindNoVerifyResponse::UserBindNoVerifyResponseData UserBindNoVerifyResponseData;
