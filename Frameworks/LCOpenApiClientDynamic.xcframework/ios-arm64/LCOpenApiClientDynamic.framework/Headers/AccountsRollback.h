...
namespace LCOpenApi{
	...
	typedef AccountsRollbackRequest::AccountsRollbackRequestData AccountsRollbackRequestData;
	...
	typedef AccountsRollbackResponse::AccountsRollbackResponseData AccountsRollbackResponseData;
