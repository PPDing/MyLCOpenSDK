...
namespace LCOpenApi{
	...
	typedef LightWorkModeSetRequest::LightWorkModeSetRequestData LightWorkModeSetRequestData;
	...
	typedef LightWorkModeSetResponse::LightWorkModeSetResponseData LightWorkModeSetResponseData;
