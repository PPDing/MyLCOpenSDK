...
namespace LCOpenApi{
	...
	typedef SetUserAuthTagetRequest::SetUserAuthTagetRequestData SetUserAuthTagetRequestData;
	...
	typedef SetUserAuthTagetResponse::SetUserAuthTagetResponseData SetUserAuthTagetResponseData;
