...
namespace LCOpenApi{
	...
	typedef DoorbellMusicListRequest::DoorbellMusicListRequestData DoorbellMusicListRequestData;
	...
	typedef DoorbellMusicListResponse::DoorbellMusicListResponseData DoorbellMusicListResponseData;
	typedef DoorbellMusicListResponse::DoorbellMusicListResponseData::DoorbellMusicListResponseData_ListElement DoorbellMusicListResponseData_ListElement;
