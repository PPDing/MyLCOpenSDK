...
namespace LCOpenApi{
	...
	typedef BellsLinkageListRequest::BellsLinkageListRequestData BellsLinkageListRequestData;
	...
	typedef BellsLinkageListResponse::BellsLinkageListResponseData BellsLinkageListResponseData;
	typedef BellsLinkageListResponse::BellsLinkageListResponseData::BellsLinkageListResponseData_InfosElement BellsLinkageListResponseData_InfosElement;
