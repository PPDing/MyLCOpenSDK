...
namespace LCOpenApi{
	...
	typedef DeviceBaseListRequest::DeviceBaseListRequestData DeviceBaseListRequestData;
	...
	typedef DeviceBaseListResponse::DeviceBaseListResponseData DeviceBaseListResponseData;
	typedef DeviceBaseListResponse::DeviceBaseListResponseData::DeviceBaseListResponseData_DeviceListElement DeviceBaseListResponseData_DeviceListElement;
	typedef DeviceBaseListResponse::DeviceBaseListResponseData::DeviceBaseListResponseData_DeviceListElement::DeviceBaseListResponseData_DeviceListElement_AplistElement DeviceBaseListResponseData_DeviceListElement_AplistElement;
	typedef DeviceBaseListResponse::DeviceBaseListResponseData::DeviceBaseListResponseData_DeviceListElement::DeviceBaseListResponseData_DeviceListElement_ChannelsElement DeviceBaseListResponseData_DeviceListElement_ChannelsElement;
