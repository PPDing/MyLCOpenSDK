...
namespace LCOpenApi{
	...
	typedef SetRecordSecretKeyRequest::SetRecordSecretKeyRequestData SetRecordSecretKeyRequestData;
	...
	typedef SetRecordSecretKeyResponse::SetRecordSecretKeyResponseData SetRecordSecretKeyResponseData;
