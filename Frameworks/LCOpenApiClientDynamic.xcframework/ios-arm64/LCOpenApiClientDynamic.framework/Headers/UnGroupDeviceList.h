...
namespace LCOpenApi{
	...
	typedef UnGroupDeviceListRequest::UnGroupDeviceListRequestData UnGroupDeviceListRequestData;
	...
	typedef UnGroupDeviceListResponse::UnGroupDeviceListResponseData UnGroupDeviceListResponseData;
	typedef UnGroupDeviceListResponse::UnGroupDeviceListResponseData::UnGroupDeviceListResponseData_DevicesElement UnGroupDeviceListResponseData_DevicesElement;
	typedef UnGroupDeviceListResponse::UnGroupDeviceListResponseData::UnGroupDeviceListResponseData_DevicesElement::UnGroupDeviceListResponseData_DevicesElement_ChannelsElement UnGroupDeviceListResponseData_DevicesElement_ChannelsElement;
