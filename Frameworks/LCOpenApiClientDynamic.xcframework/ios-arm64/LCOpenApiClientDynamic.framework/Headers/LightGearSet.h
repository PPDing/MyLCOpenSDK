...
namespace LCOpenApi{
	...
	typedef LightGearSetRequest::LightGearSetRequestData LightGearSetRequestData;
	...
	typedef LightGearSetResponse::LightGearSetResponseData LightGearSetResponseData;
