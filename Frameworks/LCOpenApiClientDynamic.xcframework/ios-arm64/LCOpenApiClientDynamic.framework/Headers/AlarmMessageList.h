...
namespace LCOpenApi{
	...
	typedef AlarmMessageListRequest::AlarmMessageListRequestData AlarmMessageListRequestData;
	...
	typedef AlarmMessageListResponse::AlarmMessageListResponseData AlarmMessageListResponseData;
	typedef AlarmMessageListResponse::AlarmMessageListResponseData::AlarmMessageListResponseData_AlarmsElement AlarmMessageListResponseData_AlarmsElement;
