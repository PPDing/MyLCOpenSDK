...
namespace LCOpenApi{
	...
	typedef DeviceRingtoneSetRequest::DeviceRingtoneSetRequestData DeviceRingtoneSetRequestData;
	...
	typedef DeviceRingtoneSetResponse::DeviceRingtoneSetResponseData DeviceRingtoneSetResponseData;
