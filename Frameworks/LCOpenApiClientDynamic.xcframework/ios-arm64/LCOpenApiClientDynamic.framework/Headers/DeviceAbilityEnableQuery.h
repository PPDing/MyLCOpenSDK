...
namespace LCOpenApi{
	...
	typedef DeviceAbilityEnableQueryRequest::DeviceAbilityEnableQueryRequestData DeviceAbilityEnableQueryRequestData;
	typedef DeviceAbilityEnableQueryRequest::DeviceAbilityEnableQueryRequestData::DeviceAbilityEnableQueryRequestData_DeviceElement DeviceAbilityEnableQueryRequestData_DeviceElement;
	typedef DeviceAbilityEnableQueryRequest::DeviceAbilityEnableQueryRequestData::DeviceAbilityEnableQueryRequestData_ChannelsElement DeviceAbilityEnableQueryRequestData_ChannelsElement;
	...
	typedef DeviceAbilityEnableQueryResponse::DeviceAbilityEnableQueryResponseData DeviceAbilityEnableQueryResponseData;
	typedef DeviceAbilityEnableQueryResponse::DeviceAbilityEnableQueryResponseData::DeviceAbilityEnableQueryResponseData_DeviceElement DeviceAbilityEnableQueryResponseData_DeviceElement;
	typedef DeviceAbilityEnableQueryResponse::DeviceAbilityEnableQueryResponseData::DeviceAbilityEnableQueryResponseData_ChannelsElement DeviceAbilityEnableQueryResponseData_ChannelsElement;
	typedef DeviceAbilityEnableQueryResponse::DeviceAbilityEnableQueryResponseData::DeviceAbilityEnableQueryResponseData_ChannelsElement::DeviceAbilityEnableQueryResponseData_ChannelsElement_DetailElement DeviceAbilityEnableQueryResponseData_ChannelsElement_DetailElement;
