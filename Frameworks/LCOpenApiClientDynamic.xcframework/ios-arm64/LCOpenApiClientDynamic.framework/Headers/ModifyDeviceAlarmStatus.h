...
namespace LCOpenApi{
	...
	typedef ModifyDeviceAlarmStatusRequest::ModifyDeviceAlarmStatusRequestData ModifyDeviceAlarmStatusRequestData;
	...
	typedef ModifyDeviceAlarmStatusResponse::ModifyDeviceAlarmStatusResponseData ModifyDeviceAlarmStatusResponseData;
