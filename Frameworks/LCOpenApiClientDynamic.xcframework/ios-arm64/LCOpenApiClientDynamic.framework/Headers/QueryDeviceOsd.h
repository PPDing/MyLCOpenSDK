...
namespace LCOpenApi{
	...
	typedef QueryDeviceOsdRequest::QueryDeviceOsdRequestData QueryDeviceOsdRequestData;
	...
	typedef QueryDeviceOsdResponse::QueryDeviceOsdResponseData QueryDeviceOsdResponseData;
