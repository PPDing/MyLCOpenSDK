...
namespace LCOpenApi{
	...
	typedef QueryBaseDeviceChannelInfoRequest::QueryBaseDeviceChannelInfoRequestData QueryBaseDeviceChannelInfoRequestData;
	...
	typedef QueryBaseDeviceChannelInfoResponse::QueryBaseDeviceChannelInfoResponseData QueryBaseDeviceChannelInfoResponseData;
	typedef QueryBaseDeviceChannelInfoResponse::QueryBaseDeviceChannelInfoResponseData::QueryBaseDeviceChannelInfoResponseData_DevicesElement QueryBaseDeviceChannelInfoResponseData_DevicesElement;
	typedef QueryBaseDeviceChannelInfoResponse::QueryBaseDeviceChannelInfoResponseData::QueryBaseDeviceChannelInfoResponseData_DevicesElement::QueryBaseDeviceChannelInfoResponseData_DevicesElement_ChannelsElement QueryBaseDeviceChannelInfoResponseData_DevicesElement_ChannelsElement;
