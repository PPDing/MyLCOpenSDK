...
namespace LCOpenApi{
	...
	typedef SetDeviceCameraStatusRequest::SetDeviceCameraStatusRequestData SetDeviceCameraStatusRequestData;
	...
	typedef SetDeviceCameraStatusResponse::SetDeviceCameraStatusResponseData SetDeviceCameraStatusResponseData;
