...
namespace LCOpenApi{
	...
	typedef BindDeviceInfoRequest::BindDeviceInfoRequestData BindDeviceInfoRequestData;
	...
	typedef BindDeviceInfoResponse::BindDeviceInfoResponseData BindDeviceInfoResponseData;
	typedef BindDeviceInfoResponse::BindDeviceInfoResponseData::BindDeviceInfoResponseData_ChannelsElement BindDeviceInfoResponseData_ChannelsElement;
