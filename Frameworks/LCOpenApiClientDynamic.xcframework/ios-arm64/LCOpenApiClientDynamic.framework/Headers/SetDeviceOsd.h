...
namespace LCOpenApi{
	...
	typedef SetDeviceOsdRequest::SetDeviceOsdRequestData SetDeviceOsdRequestData;
	...
	typedef SetDeviceOsdResponse::SetDeviceOsdResponseData SetDeviceOsdResponseData;
