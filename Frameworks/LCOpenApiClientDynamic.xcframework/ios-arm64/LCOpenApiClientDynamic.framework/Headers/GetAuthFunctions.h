...
namespace LCOpenApi{
	...
	typedef GetAuthFunctionsRequest::GetAuthFunctionsRequestData GetAuthFunctionsRequestData;
	...
	typedef GetAuthFunctionsResponse::GetAuthFunctionsResponseData GetAuthFunctionsResponseData;
	typedef GetAuthFunctionsResponse::GetAuthFunctionsResponseData::GetAuthFunctionsResponseData_AuthFunctionsElement GetAuthFunctionsResponseData_AuthFunctionsElement;
