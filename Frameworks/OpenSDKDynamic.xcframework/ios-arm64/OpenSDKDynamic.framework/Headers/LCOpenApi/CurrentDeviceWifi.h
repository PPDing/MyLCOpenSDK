...
namespace LCOpenApi{
	...
	typedef CurrentDeviceWifiRequest::CurrentDeviceWifiRequestData CurrentDeviceWifiRequestData;
	...
	typedef CurrentDeviceWifiResponse::CurrentDeviceWifiResponseData CurrentDeviceWifiResponseData;
