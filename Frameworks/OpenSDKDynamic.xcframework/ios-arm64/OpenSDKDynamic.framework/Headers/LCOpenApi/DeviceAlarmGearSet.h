...
namespace LCOpenApi{
	...
	typedef DeviceAlarmGearSetRequest::DeviceAlarmGearSetRequestData DeviceAlarmGearSetRequestData;
	...
	typedef DeviceAlarmGearSetResponse::DeviceAlarmGearSetResponseData DeviceAlarmGearSetResponseData;
