...
namespace LCOpenApi{
	...
	typedef QueryCloudRecordNumRequest::QueryCloudRecordNumRequestData QueryCloudRecordNumRequestData;
	...
	typedef QueryCloudRecordNumResponse::QueryCloudRecordNumResponseData QueryCloudRecordNumResponseData;
