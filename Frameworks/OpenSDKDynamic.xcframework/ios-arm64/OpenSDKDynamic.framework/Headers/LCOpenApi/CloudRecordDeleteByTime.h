...
namespace LCOpenApi{
	...
	typedef CloudRecordDeleteByTimeRequest::CloudRecordDeleteByTimeRequestData CloudRecordDeleteByTimeRequestData;
	...
	typedef CloudRecordDeleteByTimeResponse::CloudRecordDeleteByTimeResponseData CloudRecordDeleteByTimeResponseData;
