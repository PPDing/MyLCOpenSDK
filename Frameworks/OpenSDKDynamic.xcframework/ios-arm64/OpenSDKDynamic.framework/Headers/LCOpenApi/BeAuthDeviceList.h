...
namespace LCOpenApi{
	...
	typedef BeAuthDeviceListRequest::BeAuthDeviceListRequestData BeAuthDeviceListRequestData;
	...
	typedef BeAuthDeviceListResponse::BeAuthDeviceListResponseData BeAuthDeviceListResponseData;
	typedef BeAuthDeviceListResponse::BeAuthDeviceListResponseData::BeAuthDeviceListResponseData_DevicesElement BeAuthDeviceListResponseData_DevicesElement;
