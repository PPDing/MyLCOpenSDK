...
namespace LCOpenApi{
	...
	typedef DoorsLinkageListRequest::DoorsLinkageListRequestData DoorsLinkageListRequestData;
	...
	typedef DoorsLinkageListResponse::DoorsLinkageListResponseData DoorsLinkageListResponseData;
	typedef DoorsLinkageListResponse::DoorsLinkageListResponseData::DoorsLinkageListResponseData_InfosElement DoorsLinkageListResponseData_InfosElement;
