...
namespace LCOpenApi{
	...
	typedef PirSensitivitySetRequest::PirSensitivitySetRequestData PirSensitivitySetRequestData;
	typedef PirSensitivitySetRequest::PirSensitivitySetRequestData::PirSensitivitySetRequestData_ShapedEnableElement PirSensitivitySetRequestData_ShapedEnableElement;
	...
	typedef PirSensitivitySetResponse::PirSensitivitySetResponseData PirSensitivitySetResponseData;
