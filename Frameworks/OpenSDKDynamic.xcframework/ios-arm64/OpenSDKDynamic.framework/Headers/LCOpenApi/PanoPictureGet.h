...
namespace LCOpenApi{
	...
	typedef PanoPictureGetRequest::PanoPictureGetRequestData PanoPictureGetRequestData;
	...
	typedef PanoPictureGetResponse::PanoPictureGetResponseData PanoPictureGetResponseData;
