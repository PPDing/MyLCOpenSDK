...
namespace LCOpenApi{
	...
	typedef QueryLocalRecordNumRequest::QueryLocalRecordNumRequestData QueryLocalRecordNumRequestData;
	...
	typedef QueryLocalRecordNumResponse::QueryLocalRecordNumResponseData QueryLocalRecordNumResponseData;
