...
namespace LCOpenApi{
	...
	typedef WifiCheckAddrGetRequest::WifiCheckAddrGetRequestData WifiCheckAddrGetRequestData;
	...
	typedef WifiCheckAddrGetResponse::WifiCheckAddrGetResponseData WifiCheckAddrGetResponseData;
