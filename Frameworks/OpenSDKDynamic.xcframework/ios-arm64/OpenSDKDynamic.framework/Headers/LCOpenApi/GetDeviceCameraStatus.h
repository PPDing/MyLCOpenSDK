...
namespace LCOpenApi{
	...
	typedef GetDeviceCameraStatusRequest::GetDeviceCameraStatusRequestData GetDeviceCameraStatusRequestData;
	...
	typedef GetDeviceCameraStatusResponse::GetDeviceCameraStatusResponseData GetDeviceCameraStatusResponseData;
