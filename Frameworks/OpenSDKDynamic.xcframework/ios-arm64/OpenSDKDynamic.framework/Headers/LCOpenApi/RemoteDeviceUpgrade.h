...
namespace LCOpenApi{
	...
	typedef RemoteDeviceUpgradeRequest::RemoteDeviceUpgradeRequestData RemoteDeviceUpgradeRequestData;
	...
	typedef RemoteDeviceUpgradeResponse::RemoteDeviceUpgradeResponseData RemoteDeviceUpgradeResponseData;
