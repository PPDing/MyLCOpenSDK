...
namespace LCOpenApi{
	...
	typedef PassengerFlowRequest::PassengerFlowRequestData PassengerFlowRequestData;
	...
	typedef PassengerFlowResponse::PassengerFlowResponseData PassengerFlowResponseData;
