...
namespace LCOpenApi{
	...
	typedef PanoScanProgressGetRequest::PanoScanProgressGetRequestData PanoScanProgressGetRequestData;
	...
	typedef PanoScanProgressGetResponse::PanoScanProgressGetResponseData PanoScanProgressGetResponseData;
