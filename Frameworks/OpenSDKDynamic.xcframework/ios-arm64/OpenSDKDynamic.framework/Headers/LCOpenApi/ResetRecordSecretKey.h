...
namespace LCOpenApi{
	...
	typedef ResetRecordSecretKeyRequest::ResetRecordSecretKeyRequestData ResetRecordSecretKeyRequestData;
	...
	typedef ResetRecordSecretKeyResponse::ResetRecordSecretKeyResponseData ResetRecordSecretKeyResponseData;
