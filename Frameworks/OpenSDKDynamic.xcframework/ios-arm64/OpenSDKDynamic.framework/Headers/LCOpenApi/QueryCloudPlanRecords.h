...
namespace LCOpenApi{
	...
	typedef QueryCloudPlanRecordsRequest::QueryCloudPlanRecordsRequestData QueryCloudPlanRecordsRequestData;
	...
	typedef QueryCloudPlanRecordsResponse::QueryCloudPlanRecordsResponseData QueryCloudPlanRecordsResponseData;
	typedef QueryCloudPlanRecordsResponse::QueryCloudPlanRecordsResponseData::QueryCloudPlanRecordsResponseData_RecordsElement QueryCloudPlanRecordsResponseData_RecordsElement;
