...
namespace LCOpenApi{
	...
	typedef QueryLiveStatusRequest::QueryLiveStatusRequestData QueryLiveStatusRequestData;
	...
	typedef QueryLiveStatusResponse::QueryLiveStatusResponseData QueryLiveStatusResponseData;
	typedef QueryLiveStatusResponse::QueryLiveStatusResponseData::QueryLiveStatusResponseData_StreamsElement QueryLiveStatusResponseData_StreamsElement;
