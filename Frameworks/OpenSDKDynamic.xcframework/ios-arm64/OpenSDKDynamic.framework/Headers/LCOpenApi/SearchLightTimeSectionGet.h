...
namespace LCOpenApi{
	...
	typedef SearchLightTimeSectionGetRequest::SearchLightTimeSectionGetRequestData SearchLightTimeSectionGetRequestData;
	...
	typedef SearchLightTimeSectionGetResponse::SearchLightTimeSectionGetResponseData SearchLightTimeSectionGetResponseData;
	typedef SearchLightTimeSectionGetResponse::SearchLightTimeSectionGetResponseData::SearchLightTimeSectionGetResponseData_ChannelsElement SearchLightTimeSectionGetResponseData_ChannelsElement;
	typedef SearchLightTimeSectionGetResponse::SearchLightTimeSectionGetResponseData::SearchLightTimeSectionGetResponseData_ChannelsElement::SearchLightTimeSectionGetResponseData_ChannelsElement_RulesElement SearchLightTimeSectionGetResponseData_ChannelsElement_RulesElement;
