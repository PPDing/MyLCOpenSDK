...
namespace LCOpenApi{
	...
	typedef GetDoorbellMusicVolumeRequest::GetDoorbellMusicVolumeRequestData GetDoorbellMusicVolumeRequestData;
	...
	typedef GetDoorbellMusicVolumeResponse::GetDoorbellMusicVolumeResponseData GetDoorbellMusicVolumeResponseData;
