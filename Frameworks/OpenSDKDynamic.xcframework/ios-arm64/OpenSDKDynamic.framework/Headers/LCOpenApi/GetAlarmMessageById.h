...
namespace LCOpenApi{
	...
	typedef GetAlarmMessageByIdRequest::GetAlarmMessageByIdRequestData GetAlarmMessageByIdRequestData;
	...
	typedef GetAlarmMessageByIdResponse::GetAlarmMessageByIdResponseData GetAlarmMessageByIdResponseData;
