...
namespace LCOpenApi{
	...
	typedef TimeZoneConfigByDayRequest::TimeZoneConfigByDayRequestData TimeZoneConfigByDayRequestData;
	...
	typedef TimeZoneConfigByDayResponse::TimeZoneConfigByDayResponseData TimeZoneConfigByDayResponseData;
