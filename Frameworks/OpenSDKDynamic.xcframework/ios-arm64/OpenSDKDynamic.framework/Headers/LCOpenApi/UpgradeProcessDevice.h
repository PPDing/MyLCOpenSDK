...
namespace LCOpenApi{
	...
	typedef UpgradeProcessDeviceRequest::UpgradeProcessDeviceRequestData UpgradeProcessDeviceRequestData;
	...
	typedef UpgradeProcessDeviceResponse::UpgradeProcessDeviceResponseData UpgradeProcessDeviceResponseData;
