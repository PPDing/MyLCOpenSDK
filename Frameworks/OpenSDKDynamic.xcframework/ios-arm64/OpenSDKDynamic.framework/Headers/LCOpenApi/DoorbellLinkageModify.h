...
namespace LCOpenApi{
	...
	typedef DoorbellLinkageModifyRequest::DoorbellLinkageModifyRequestData DoorbellLinkageModifyRequestData;
	...
	typedef DoorbellLinkageModifyResponse::DoorbellLinkageModifyResponseData DoorbellLinkageModifyResponseData;
