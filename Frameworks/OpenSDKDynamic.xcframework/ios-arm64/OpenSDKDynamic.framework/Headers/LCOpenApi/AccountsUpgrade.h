...
namespace LCOpenApi{
	...
	typedef AccountsUpgradeRequest::AccountsUpgradeRequestData AccountsUpgradeRequestData;
	...
	typedef AccountsUpgradeResponse::AccountsUpgradeResponseData AccountsUpgradeResponseData;
