...
namespace LCOpenApi{
	...
	typedef SetCruiseConfigRequest::SetCruiseConfigRequestData SetCruiseConfigRequestData;
	typedef SetCruiseConfigRequest::SetCruiseConfigRequestData::SetCruiseConfigRequestData_CruisePlan SetCruiseConfigRequestData_CruisePlan;
	typedef SetCruiseConfigRequest::SetCruiseConfigRequestData::SetCruiseConfigRequestData_CruisePlan::SetCruiseConfigRequestData_CruisePlan_CollectionElement SetCruiseConfigRequestData_CruisePlan_CollectionElement;
	typedef SetCruiseConfigRequest::SetCruiseConfigRequestData::SetCruiseConfigRequestData_CruisePlan::SetCruiseConfigRequestData_CruisePlan_CruisesElement SetCruiseConfigRequestData_CruisePlan_CruisesElement;
	...
	typedef SetCruiseConfigResponse::SetCruiseConfigResponseData SetCruiseConfigResponseData;
