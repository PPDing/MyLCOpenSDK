...
namespace LCOpenApi{
	...
	typedef GetHeatMapEnableRequest::GetHeatMapEnableRequestData GetHeatMapEnableRequestData;
	...
	typedef GetHeatMapEnableResponse::GetHeatMapEnableResponseData GetHeatMapEnableResponseData;
