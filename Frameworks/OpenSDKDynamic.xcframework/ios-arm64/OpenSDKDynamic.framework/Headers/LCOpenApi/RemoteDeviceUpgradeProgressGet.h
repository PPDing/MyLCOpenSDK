...
namespace LCOpenApi{
	...
	typedef RemoteDeviceUpgradeProgressGetRequest::RemoteDeviceUpgradeProgressGetRequestData RemoteDeviceUpgradeProgressGetRequestData;
	...
	typedef RemoteDeviceUpgradeProgressGetResponse::RemoteDeviceUpgradeProgressGetResponseData RemoteDeviceUpgradeProgressGetResponseData;
