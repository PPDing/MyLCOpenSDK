...
namespace LCOpenApi{
	...
	typedef LightGearListRequest::LightGearListRequestData LightGearListRequestData;
	...
	typedef LightGearListResponse::LightGearListResponseData LightGearListResponseData;
	typedef LightGearListResponse::LightGearListResponseData::LightGearListResponseData_GearElement LightGearListResponseData_GearElement;
