...
namespace LCOpenApi{
	...
	typedef DeviceCloudListRequest::DeviceCloudListRequestData DeviceCloudListRequestData;
	...
	typedef DeviceCloudListResponse::DeviceCloudListResponseData DeviceCloudListResponseData;
	typedef DeviceCloudListResponse::DeviceCloudListResponseData::DeviceCloudListResponseData_StrategiesElement DeviceCloudListResponseData_StrategiesElement;
