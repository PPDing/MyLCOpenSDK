...
namespace LCOpenApi{
	...
	typedef DeviceListRequest::DeviceListRequestData DeviceListRequestData;
	...
	typedef DeviceListResponse::DeviceListResponseData DeviceListResponseData;
	typedef DeviceListResponse::DeviceListResponseData::DeviceListResponseData_DevicesElement DeviceListResponseData_DevicesElement;
	typedef DeviceListResponse::DeviceListResponseData::DeviceListResponseData_DevicesElement::DeviceListResponseData_DevicesElement_ChannelsElement DeviceListResponseData_DevicesElement_ChannelsElement;
