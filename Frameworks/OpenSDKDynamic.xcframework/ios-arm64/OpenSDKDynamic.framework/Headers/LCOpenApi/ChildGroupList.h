...
namespace LCOpenApi{
	...
	typedef ChildGroupListRequest::ChildGroupListRequestData ChildGroupListRequestData;
	...
	typedef ChildGroupListResponse::ChildGroupListResponseData ChildGroupListResponseData;
	typedef ChildGroupListResponse::ChildGroupListResponseData::ChildGroupListResponseData_GroupsElement ChildGroupListResponseData_GroupsElement;
