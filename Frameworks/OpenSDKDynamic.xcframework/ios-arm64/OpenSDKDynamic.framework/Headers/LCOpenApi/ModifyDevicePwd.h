...
namespace LCOpenApi{
	...
	typedef ModifyDevicePwdRequest::ModifyDevicePwdRequestData ModifyDevicePwdRequestData;
	...
	typedef ModifyDevicePwdResponse::ModifyDevicePwdResponseData ModifyDevicePwdResponseData;
