...
namespace LCOpenApi{
	...
	typedef ControlDeviceWifiRequest::ControlDeviceWifiRequestData ControlDeviceWifiRequestData;
	...
	typedef ControlDeviceWifiResponse::ControlDeviceWifiResponseData ControlDeviceWifiResponseData;
