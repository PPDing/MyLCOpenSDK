...
namespace LCOpenApi{
	...
	typedef DoorbellLinkageAddRequest::DoorbellLinkageAddRequestData DoorbellLinkageAddRequestData;
	...
	typedef DoorbellLinkageAddResponse::DoorbellLinkageAddResponseData DoorbellLinkageAddResponseData;
