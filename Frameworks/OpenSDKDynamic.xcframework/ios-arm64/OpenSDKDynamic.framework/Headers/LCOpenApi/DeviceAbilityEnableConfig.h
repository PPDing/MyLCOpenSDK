...
namespace LCOpenApi{
	...
	typedef DeviceAbilityEnableConfigRequest::DeviceAbilityEnableConfigRequestData DeviceAbilityEnableConfigRequestData;
	typedef DeviceAbilityEnableConfigRequest::DeviceAbilityEnableConfigRequestData::DeviceAbilityEnableConfigRequestData_DeviceElement DeviceAbilityEnableConfigRequestData_DeviceElement;
	typedef DeviceAbilityEnableConfigRequest::DeviceAbilityEnableConfigRequestData::DeviceAbilityEnableConfigRequestData_ChannelsElement DeviceAbilityEnableConfigRequestData_ChannelsElement;
	typedef DeviceAbilityEnableConfigRequest::DeviceAbilityEnableConfigRequestData::DeviceAbilityEnableConfigRequestData_ChannelsElement::DeviceAbilityEnableConfigRequestData_ChannelsElement_DetailElement DeviceAbilityEnableConfigRequestData_ChannelsElement_DetailElement;
	...
	typedef DeviceAbilityEnableConfigResponse::DeviceAbilityEnableConfigResponseData DeviceAbilityEnableConfigResponseData;
