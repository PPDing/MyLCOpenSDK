...
namespace LCOpenApi{
	...
	typedef ShareDeviceListRequest::ShareDeviceListRequestData ShareDeviceListRequestData;
	...
	typedef ShareDeviceListResponse::ShareDeviceListResponseData ShareDeviceListResponseData;
	typedef ShareDeviceListResponse::ShareDeviceListResponseData::ShareDeviceListResponseData_DevicesElement ShareDeviceListResponseData_DevicesElement;
	typedef ShareDeviceListResponse::ShareDeviceListResponseData::ShareDeviceListResponseData_DevicesElement::ShareDeviceListResponseData_DevicesElement_ChannelsElement ShareDeviceListResponseData_DevicesElement_ChannelsElement;
