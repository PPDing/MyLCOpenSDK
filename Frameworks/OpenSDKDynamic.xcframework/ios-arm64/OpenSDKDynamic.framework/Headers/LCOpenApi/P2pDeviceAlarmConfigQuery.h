...
namespace LCOpenApi{
	...
	typedef P2pDeviceAlarmConfigQueryRequest::P2pDeviceAlarmConfigQueryRequestData P2pDeviceAlarmConfigQueryRequestData;
	...
	typedef P2pDeviceAlarmConfigQueryResponse::P2pDeviceAlarmConfigQueryResponseData P2pDeviceAlarmConfigQueryResponseData;
	typedef P2pDeviceAlarmConfigQueryResponse::P2pDeviceAlarmConfigQueryResponseData::P2pDeviceAlarmConfigQueryResponseData_DeviceListElement P2pDeviceAlarmConfigQueryResponseData_DeviceListElement;
	typedef P2pDeviceAlarmConfigQueryResponse::P2pDeviceAlarmConfigQueryResponseData::P2pDeviceAlarmConfigQueryResponseData_DeviceListElement::P2pDeviceAlarmConfigQueryResponseData_DeviceListElement_ConfigsElement P2pDeviceAlarmConfigQueryResponseData_DeviceListElement_ConfigsElement;
