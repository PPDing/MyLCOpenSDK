...
namespace LCOpenApi{
	...
	typedef QueryOpenDeviceChannelInfoRequest::QueryOpenDeviceChannelInfoRequestData QueryOpenDeviceChannelInfoRequestData;
	...
	typedef QueryOpenDeviceChannelInfoResponse::QueryOpenDeviceChannelInfoResponseData QueryOpenDeviceChannelInfoResponseData;
	typedef QueryOpenDeviceChannelInfoResponse::QueryOpenDeviceChannelInfoResponseData::QueryOpenDeviceChannelInfoResponseData_DevicesElement QueryOpenDeviceChannelInfoResponseData_DevicesElement;
	typedef QueryOpenDeviceChannelInfoResponse::QueryOpenDeviceChannelInfoResponseData::QueryOpenDeviceChannelInfoResponseData_DevicesElement::QueryOpenDeviceChannelInfoResponseData_DevicesElement_ChannelsElement QueryOpenDeviceChannelInfoResponseData_DevicesElement_ChannelsElement;
