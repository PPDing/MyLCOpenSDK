...
namespace LCOpenApi{
	...
	typedef PanoScanStartRequest::PanoScanStartRequestData PanoScanStartRequestData;
	...
	typedef PanoScanStartResponse::PanoScanStartResponseData PanoScanStartResponseData;
