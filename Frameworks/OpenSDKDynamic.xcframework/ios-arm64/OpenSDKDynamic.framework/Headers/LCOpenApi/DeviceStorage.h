...
namespace LCOpenApi{
	...
	typedef DeviceStorageRequest::DeviceStorageRequestData DeviceStorageRequestData;
	...
	typedef DeviceStorageResponse::DeviceStorageResponseData DeviceStorageResponseData;
