...
namespace LCOpenApi{
	...
	typedef ModifyDeviceAlarmPlanRequest::ModifyDeviceAlarmPlanRequestData ModifyDeviceAlarmPlanRequestData;
	...
	typedef ModifyDeviceAlarmPlanResponse::ModifyDeviceAlarmPlanResponseData ModifyDeviceAlarmPlanResponseData;
