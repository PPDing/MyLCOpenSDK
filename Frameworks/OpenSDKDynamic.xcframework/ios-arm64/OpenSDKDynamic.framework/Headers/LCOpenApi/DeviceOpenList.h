...
namespace LCOpenApi{
	...
	typedef DeviceOpenListRequest::DeviceOpenListRequestData DeviceOpenListRequestData;
	...
	typedef DeviceOpenListResponse::DeviceOpenListResponseData DeviceOpenListResponseData;
	typedef DeviceOpenListResponse::DeviceOpenListResponseData::DeviceOpenListResponseData_DeviceListElement DeviceOpenListResponseData_DeviceListElement;
	typedef DeviceOpenListResponse::DeviceOpenListResponseData::DeviceOpenListResponseData_DeviceListElement::DeviceOpenListResponseData_DeviceListElement_AplistElement DeviceOpenListResponseData_DeviceListElement_AplistElement;
	typedef DeviceOpenListResponse::DeviceOpenListResponseData::DeviceOpenListResponseData_DeviceListElement::DeviceOpenListResponseData_DeviceListElement_ChannelsElement DeviceOpenListResponseData_DeviceListElement_ChannelsElement;
